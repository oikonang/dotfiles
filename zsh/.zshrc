...
# This is a visual studio code shortcut on terminal
function code {
    if [[ $# = 0 ]]
    then
...
zplug "plugins/anaconda",          from:oh-my-zsh
...
# It must be placed at the end of the file to have effect. It changes suggestion color
...
if zplug check "bhilburn/powerlevel9k"; then
    ...
    POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(command_execution_time background_jobs status anaconda time)
